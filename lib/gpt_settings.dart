...
class Gpt {
    ...
    var body = jsonEncode(
        {
          ...
          "messages": [
            ...
            {
              "role": "user",
              "text": "Дай мне маленький интересный факт о ${Game.word}. Напоминаю, замени все вхождения слова ${Game.word} в любой его форме на '...'"
            }
          ]
        }
    );
  ...
  static Future<String> generateEndFact() async{
    var headers = {
      "Content-type": "application/json",
      "Authorization": "Api-Key $API_TOKEN",
      "x-folder-id": FOLDER_ID
    ...
    var body = jsonEncode(
        {
          ...
          "messages": [
            {
              "role": "system",
              "text": "Ты знаешь много интересных фактов обо всём. Я буду говрить тебе слово на английском, а ты будешь давать мне факт на английском о нём. Формат ответа - факт на английском",
            },
            {
              "role": "user",
              "text": "Дай мне длинный интересный факт о ${Game.word}"
            }
          ]
        }
    );
